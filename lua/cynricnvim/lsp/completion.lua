cynric.plugins["blink-cmp"] = {
    "saghen/blink.cmp",
    dependencies = { "rafamadriz/friendly-snippets" },
    event = { "InsertEnter", "CmdlineEnter", "User cynricLoad" },
    version = "*",
    opts = {
        appearance = {
            kind_icons = cynric.symbols,
        },
        cmdline = {
            completion = {
                menu = {
        ...
        sources = {
            default = function()
                ...
                if cynric.__FITTENCODE_SOURCE_ADDED then
                    source[#source + 1] = "fittencode"
                end
                if vim.bo.filetype == "org" and cynric.__ORGMODE_SOURCE_ADDED then
